...
KTBM_PrintSceneListToTXT = function(kScene, txtName)
    ...
    if print_scene_camera then
        ...
        if cam_properties then
            ...
            for b, cam_property_key in ipairs(cam_property_keys) do
                ...
                local cam_propety_key_string       = KTBM_KeyToString(cam_property_key)
                local cam_property_key_type_string = KTBM_KeyToString(cam_property_value_type)
                
                --convert these to a string using a special function to format it nicely
                local cam_property_value_string      = KTBM_KeyToString(cam_property_value)
                local cam_property_value_type_string = KTBM_KeyToString(cam_property_key_type)
                ...
                if cam_property_key_type_string == "table" then
                    ...
                    main_txt_file:write(KTBM_TablePrint(cam_property_value), "\n")
                end
            end
    ...
    for i, agent_object in pairs(scene_agents) do
        ...
        if agent_properties and print_agent_properties then
            ...
            for x, agent_property_key in ipairs(agent_property_keys) do
                ...
                --convert these to a string using a special function to format it nicely
                local agent_propety_key_string       = KTBM_KeyToString(agent_property_key)
                local agent_property_key_type_string = KTBM_KeyToString(agent_property_value_type)
                
                --convert these to a string using a special function to format it nicely
                local agent_property_value_string      = KTBM_KeyToString(agent_property_value)
                local agent_property_value_type_string = KTBM_KeyToString(agent_property_key_type)
                ...
                if agent_property_key_type_string == "table" then
                    ...
                    main_txt_file:write(KTBM_TablePrint(agent_property_value), "\n")
                end
...
KTBM_PrintChoreAgentNames = function(choreNameString)
...
KTBM_PrintProperties = function(agent)
    ...
    for _, line in pairs(agentName_propertyName_validOnesFromFile) do
        --local testing = SymbolToString(tostring(tonumber(KTBM_KeyToString(line))));
        --local testing = SymbolToString(tonumber(KTBM_KeyToString(line)));
...
KTBM_PrintPropertiesFromPropertySet = function(propName, agent_properties)
    --clear the lists
    local agentName_propertyName_validOnesFromFile = {}
    local agentName_propertyName_validOnesFromFile_values = {}
    local agentName_propertyName_validOnesFromFile_valueTypes = {}
...
KTBM_GetCacheObjectName = function(string_cacheObjectName, cacheObjectListName)
...
KTBM_GetCacheObjectNamesFromProperties = function(agent, cacheObjectListName)
...
KTBM_PrintOutCacheObjectProperties = function(agent, propertyString)
    local list_lineName = {}
...
KTBM_PrintValidPropertyNames = function(agent)
    local theAgentName = AgentGetName(agent)
...
KTBM_PrintValidPropertyNamesOnPropertySet = function(newName, agent_properties)
    --clear the lists
    local agentName_propertyName_validOnesFromFile = {}
    local agentName_propertyName_validOnesFromFile_values = {}
    local agentName_propertyName_validOnesFromFile_valueTypes = {}
...
KTBM_PrintValidAgentStateNames = function(agent)
    local theAgentName = AgentGetName(agent)
...
KTBM_PrintAgentStates = function(agent)
    local theAgentName = AgentGetName(agent)
...
KTBM_PrintValidNodeNames = function(agent)
    local theAgentName = AgentGetName(agent)
