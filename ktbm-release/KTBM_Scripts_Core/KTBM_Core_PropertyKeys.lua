...
KTBM_SetPropertyBySymbol = function(properties, symbolString, newValue)
...
KTBM_AgentSetPropertyBySymbol = function(agentName, symbolString, newValue, sceneObj)
...
KTBM_SetPropertyColorBySymbol = function(properties, symbolString, newValue)
    --check if the properties isn't null
    if properties then
        --get the property keys list
        local agent_property_keys = PropertyGetKeys(properties);
